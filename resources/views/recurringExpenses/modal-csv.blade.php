<div class="modal mt-0 p-0" id="recurrentModal" tabindex="-1" aria-labelledby="expenseModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="flex flex-row justify-between">
                        ...
                        <div>
                            <button
                                ...
                                type="button" id="upload_csv_recurrent">
                                Upload csv
                            </button>
                        </div>
                    </div>
                ...
                <div class="w-full rounded-lg shadow overflow-hidden" id="response-recurrent"></div>
