<nav x-data="{ open: false }" class="bg-gray-800 ">
        ...
        <div class="flex justify-between h-16 ">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('monthly')" :active="request()->routeIs('monthly')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link :href="route('recurring-expenses')" :active="request()->routeIs('recurring-expenses')">
                        {{ __('Recurrent') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('monthly')" :active="request()->routeIs('monthly')">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('recurring-expenses')" :active="request()->routeIs('recurring-expenses')">
                {{ __('Recurrent') }}
            </x-responsive-nav-link>
